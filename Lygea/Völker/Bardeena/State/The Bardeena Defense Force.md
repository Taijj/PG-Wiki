...
In short, these are the [Bardeenian](</Lygea/Völker/Bardeena/Bardeena.md>) executive forces. They establish order and take care of the country's inner and outer defenses. As with the rest of the country, hierarchies can be rather loose here as well, at least during normal operations. However, in situations of emergency and quick decision necessity, these hierarchies tighten considerably and ranks become important, of course.
# Department of War
...
### Mystics
These soldiers develop into masterful [Mystics](</Lygea/Das Universum/Mystik/Die Mystik.md>) and fight with the full potential of their **animations**. 
All of them learn to master their own primary [Elemental](</Lygea/Das Universum/Magie/Die Elemente.md>) form (the one most natural to them), as well as a secondary one (e.g. **2-Elements**).
### Motorists
...
### Aviators
The Bardeenian airforce has not developed further than a fleet of helicopters and a single larger airship anchored at [Bavista](</Lygea/Völker/Bardeena/Locations/Bavista.md>). Still, new pilots and engineers are joining every year.
### The Elite
...
- **Captain** - Responsible to come up with and evaluate multiple missions, [Head](</Lygea/Völker/Bardeena/Bardeena.md#Hierarchies>) of a large unit like a dhip, an entire workshop or a magistrate of **Mystics**.
- **Major** - Responsible for the workings of an entire **Force**, e.g. Major Motorist, Major Aviator
- **General** - The general is the [Head](</Lygea/Völker/Bardeena/Bardeena.md#Hierarchies>) of the entire department, there is only one
## Location & Occupation
Headquarters are situated in [Bavista](</Lygea/Völker/Bardeena/Locations/Bavista.md>) since the main threat to the country is currently the [forasian nation](</Lygea/Völker/Die Forasier/Die Forasier.md>), which mainly attacks from the east. Most **Forces** are stationed there as well, so seeing any soldier anywhere else is pretty rare.
A few squads of soldiers are stationed in and around [Section I and II](</Lygea/Völker/Bardeena/State/The Institute of Science.md#Sections>), though, since the **Sections** contain a lot of knowledge vital to Bardeena's technological superiority. There are also a few expeditions done to explore still unknown parts of the continent, which are supported by military personal as well.
## Serving Time
...
## Large Cities
Since [Bavista](</Lygea/Völker/Bardeena/Locations/Bavista.md>) is the main headquarters for the [The Bardeena Defense Force](<#Department of War>), [Haarafir](</Lygea/Völker/Bardeena/Locations/Haarafir.md>) really is the only city that actually employs a larger police force. One precinct exists for each of the cities districts, while the **Chief of Police** is the department's [Head](</Lygea/Völker/Bardeena/Bardeena.md#Hierarchies>) for the city.
...
Involving the police is a decision citizens don't take lightly. If the police get involved, they'll do their best to find a culprit, which then leads to heavy fines in addition to other punishment. In the worst case, the [Department of Law](</Lygea/Völker/Bardeena/State/The National Office.md#Department of Law>) will get involved. Generally nobody wants that to happen, since court cases are very expensive. Whole lives can be destroyed by a single court case.  
...
- As soon as someone starts [animating](</Lygea/Das Universum/Mystik/Die Mystik.md#Basierend auf Animation>) in public    
- As soon as a [Child or Teenager](</Lygea/Völker/Bardeena/State/The Ministry of Community.md#Levels of Maturity>) starts animating anywhere without adult supervision
...
The licenses for weapons are handle by the police, similar to how the [Department of Mysticism](</Lygea/Völker/Bardeena/State/The Ministry of Community.md#Department of Mysticism>) hands out their **Animation Licenses**.
# Department of Warding
This department's mission is to defend Bardeena against the forces of nature themselves.
### The Ambulance
Stationed at strategic locations throughout every settlement, these will quickly jumpt to action, in case of a health emergency. They work pretty much the same way as ambulances from reality: Short reaction time, loud sirens, basic medical treatment, quick transport to the nearest [clinic](</Lygea/Völker/Bardeena/State/The Ministry of Community.md#Department of Healthcare>).
...
### The Guard
The guard's main task is to protect the citizens against the wilderness, namely the dangerous [Anomi](</Lygea/Lebewesen/Anomi/Die Anomi.md>) living there. They are the ones building, maintaining, and manning the walls around each Bardeenian settlement.
That includes the operation of sometimes elaborate warning systems, that notify the population, in case anything powerful comes too close, e.g. a large [demon](</Lygea/Lebewesen/Anomi/Dämonen/Die Dämonen.md>) or an entire horde of large [animals](</Lygea/Lebewesen/Anomi/Die Tiere.md>).
Additionally, they are also the best guides to be found for expeditions beyond the city walls.

// TODO: Ranks and Uniform
...
- anomalous [mystic](</Lygea/Das Universum/Mystik/Die Mystik.md>) phenomena, e.g. cursed objects,
- commotions caused by [disembodied souls](</Lygea/Das Universum/Magie/Körperlose Seelen.md>), e.g. [ghosts](</Lygea/Lebewesen/Anomalien/Geister.md>),
- small scale [anomi](</Lygea/Lebewesen/Anomi/Die Anomi.md>) incidents, e.g. a giant rat infestation,
...
The first companies were founded in [Haarafir](</Lygea/Völker/Bardeena/Locations/Haarafir.md>), some years after the military moved to [Bavista](</Lygea/Völker/Bardeena/Locations/Bavista.md>) by soldiers, who didn't want to move along. Despite having a rough few initial years, the most famous commission company became [Ämber](</Lygea/Völker/Bardeena/Ämber/Ämber.md>), which was founded and headed by [Jin Naidesh](</Lygea/Völker/Bardeena/Ämber/Jin Naidesh.md>).